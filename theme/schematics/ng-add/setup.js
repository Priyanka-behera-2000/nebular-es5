...
function default_1(options) {
  return schematics_1.chain([register_modules_1.registerModules(options), options.customization ? register_theme_1.registerCustomizableTheme(options) : register_theme_1.registerPrebuiltTheme(options), options.layout ? wrap_in_layout_1.wrapRootComponentInLayout(options) : schematics_1.noop()]);
}
