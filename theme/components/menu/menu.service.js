...
exports.NbMenuInternalService = exports.NbMenuService = exports.NbMenuItem = undefined;
...
var _urlMatchingHelpers = require("./url-matching-helpers");
...
var itemClick$ = new _rxjs.Subject();
var addItems$ = new _rxjs.ReplaySubject(1);
var navigateHome$ = new _rxjs.ReplaySubject(1);
var getSelectedItem$ = new _rxjs.ReplaySubject(1);
var itemSelect$ = new _rxjs.ReplaySubject(1);
var itemHover$ = new _rxjs.ReplaySubject(1);
var submenuToggle$ = new _rxjs.ReplaySubject(1);
var collapseAll$ = new _rxjs.ReplaySubject(1);
...
var NbMenuService = /** @class */function () {
    ...
    NbMenuService.prototype.getSelectedItem = function (tag) {
        var listener = new _rxjs.BehaviorSubject(null);
        getSelectedItem$.next({ tag: tag, listener: listener });
        return listener.asObservable();
    };
    NbMenuService.prototype.onItemClick = function () {
        return itemClick$.pipe((0, _operators.share)());
    };
    NbMenuService.prototype.onItemSelect = function () {
        return itemSelect$.pipe((0, _operators.share)());
    };
    NbMenuService.prototype.onItemHover = function () {
        return itemHover$.pipe((0, _operators.share)());
    };
    NbMenuService.prototype.onSubmenuToggle = function () {
        return submenuToggle$.pipe((0, _operators.share)());
    };
    NbMenuService = __decorate([(0, _core.Injectable)()], NbMenuService);
...
var NbMenuInternalService = /** @class */function () {
    ...
    NbMenuInternalService.prototype.onAddItem = function () {
        return addItems$.pipe((0, _operators.share)());
    };
    NbMenuInternalService.prototype.onNavigateHome = function () {
        return navigateHome$.pipe((0, _operators.share)());
    };
    NbMenuInternalService.prototype.onCollapseAll = function () {
        return collapseAll$.pipe((0, _operators.share)());
    };
    NbMenuInternalService.prototype.onGetSelectedItem = function () {
        return getSelectedItem$.pipe((0, _operators.share)());
    };
    ...
    NbMenuInternalService.prototype.isSelectedInUrl = function (item) {
        ...
        var link = item.link;
        var isSelectedInPath = exact ? (0, _urlMatchingHelpers.isUrlPathEqual)(this.location.path(), link) : (0, _urlMatchingHelpers.isUrlPathContain)(this.location.path(), link);
        if (isSelectedInPath && item.fragment != null) {
            return exact ? (0, _urlMatchingHelpers.isFragmentEqual)(this.location.path(), item.fragment) : (0, _urlMatchingHelpers.isFragmentContain)(this.location.path(), item.fragment);
        }
        return isSelectedInPath;
    };
    NbMenuInternalService = __decorate([(0, _core.Injectable)(), __metadata("design:paramtypes", [_common.Location])], NbMenuInternalService);
    return NbMenuInternalService;
}();
exports.NbMenuInternalService = NbMenuInternalService;
