...
exports.NbSidebarComponent = exports.NbSidebarFooterComponent = exports.NbSidebarHeaderComponent = undefined;
...
var _sidebar = require("./sidebar.service");
...
var NbSidebarHeaderComponent = /** @class */function () {
    ...
    NbSidebarHeaderComponent = __decorate([(0, _core.Component)({
...
var NbSidebarFooterComponent = /** @class */function () {
    ...
    NbSidebarFooterComponent = __decorate([(0, _core.Component)({
...
var NbSidebarComponent = /** @class */function () {
    ...
    Object.defineProperty(NbSidebarComponent.prototype, "right", {
        ...
        set: function set(val) {
            this.rightValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    Object.defineProperty(NbSidebarComponent.prototype, "end", {
         ...
         */
        set: function set(val) {
            this.endValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    Object.defineProperty(NbSidebarComponent.prototype, "containerFixed", {
         ...
         */
        set: function set(val) {
            this.containerFixedValue = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(NbSidebarComponent.prototype, "responsive", {
         ...
         */
        set: function set(val) {
            this.responsiveValue = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    ...
    NbSidebarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sidebarService.onToggle().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        ...
        this.sidebarService.onExpand().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (data) {
            if (!_this.tag || _this.tag === data.tag) {
                _this.expand();
        ...
        this.sidebarService.onCollapse().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (data) {
            if (!_this.tag || _this.tag === data.tag) {
                _this.collapse();
    ...
    NbSidebarComponent.prototype.toggle = function (compact) {
        ...
        if (compact) {
            this.state = closedStates.includes(this.stateValue) ? NbSidebarComponent_1.STATE_EXPANDED : NbSidebarComponent_1.STATE_COMPACTED;
        } else {
            this.state = closedStates.includes(this.stateValue) ? NbSidebarComponent_1.STATE_EXPANDED : NbSidebarComponent_1.STATE_COLLAPSED;
        }
    };
    NbSidebarComponent.prototype.onMediaQueryChanges = function () {
        var _this = this;
        return this.themeService.onMediaQueryChange().subscribe(function (_a) {
            var prev = _a[0],
                current = _a[1];
    ...
    __decorate([(0, _core.HostBinding)('class.fixed'), __metadata("design:type", Boolean)], NbSidebarComponent.prototype, "fixedValue", void 0);
    __decorate([(0, _core.HostBinding)('class.right'), __metadata("design:type", Boolean)], NbSidebarComponent.prototype, "rightValue", void 0);
    __decorate([(0, _core.HostBinding)('class.left'), __metadata("design:type", Boolean)], NbSidebarComponent.prototype, "leftValue", void 0);
    __decorate([(0, _core.HostBinding)('class.start'), __metadata("design:type", Boolean)], NbSidebarComponent.prototype, "startValue", void 0);
    __decorate([(0, _core.HostBinding)('class.end'), __metadata("design:type", Boolean)], NbSidebarComponent.prototype, "endValue", void 0);
    __decorate([(0, _core.HostBinding)('class.expanded'), __metadata("design:type", Object), __metadata("design:paramtypes", [])], NbSidebarComponent.prototype, "expanded", null);
    __decorate([(0, _core.HostBinding)('class.collapsed'), __metadata("design:type", Object), __metadata("design:paramtypes", [])], NbSidebarComponent.prototype, "collapsed", null);
    __decorate([(0, _core.HostBinding)('class.compacted'), __metadata("design:type", Object), __metadata("design:paramtypes", [])], NbSidebarComponent.prototype, "compacted", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "right", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "left", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "start", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "end", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "fixed", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "containerFixed", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String), __metadata("design:paramtypes", [String])], NbSidebarComponent.prototype, "state", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbSidebarComponent.prototype, "responsive", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbSidebarComponent.prototype, "tag", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Array)], NbSidebarComponent.prototype, "compactedBreakpoints", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Array)], NbSidebarComponent.prototype, "collapsedBreakpoints", void 0);
    NbSidebarComponent = NbSidebarComponent_1 = __decorate([(0, _core.Component)({
        selector: 'nb-sidebar',
    ...
    }), __metadata("design:paramtypes", [_sidebar.NbSidebarService, _theme.NbThemeService, _core.ElementRef])], NbSidebarComponent);
