...
exports.NbDynamicOverlay = undefined;
...
var NbDynamicOverlay = /** @class */function () {
    function NbDynamicOverlay(overlay, componentFactoryResolver, zone) {
        ...
        this.zone = zone;
        this.context = {};
        this.positionStrategyChange$ = new _rxjs.Subject();
        this.alive = true;
    }
    ...
    NbDynamicOverlay.prototype.setPositionStrategy = function (positionStrategy) {
        ...
        this.positionStrategy.positionChange.pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        }), (0, _operators.takeUntil)(this.positionStrategyChange$), (0, _operators.filter)(function () {
            return !!_this.container;
        })).subscribe(function (position) {
            return (0, _overlay.patch)(_this.container, { position: position });
        });
        if (this.ref) {
    ...
    NbDynamicOverlay.prototype.renderContainer = function () {
        ...
        if (!this.container) {
            this.container = (0, _overlay.createContainer)(this.ref, this.componentType, containerContext, this.componentFactoryResolver);
        }
    ...
    NbDynamicOverlay.prototype.updatePositionWhenStable = function () {
        var _this = this;
        this.zone.onStable.pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function () {
            _this.ref && _this.ref.updatePosition();
        });
    };
    NbDynamicOverlay = __decorate([(0, _core.Injectable)(), __metadata("design:paramtypes", [_overlay.NbOverlayService, _core.ComponentFactoryResolver, _core.NgZone])], NbDynamicOverlay);
