...
exports.NbToastrConfig = exports.NB_TOASTR_CONFIG = undefined;
 ...
 */
var NB_TOASTR_CONFIG = exports.NB_TOASTR_CONFIG = new _core.InjectionToken('Default toastr options');
/**
...
var NbToastrConfig = /** @class */function () {
  function NbToastrConfig(config) {
     ...
     * */
    this.position = _cdk.NbGlobalLogicalPosition.TOP_END;
    /**
