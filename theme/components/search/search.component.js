...
exports.NbSearchComponent = exports.NbSearchFieldComponent = undefined;
...
var NbSearchFieldComponent = /** @class */function () {
    function NbSearchFieldComponent() {
        ...
        this.search = new _core.EventEmitter();
        this.searchInput = new _core.EventEmitter();
    }
...
var NbSearchComponent = /** @class */function () {
    ...
    NbSearchComponent.prototype.ngOnInit = function () {
        ...
        this.router.events.pipe((0, _operators.takeWhile)(function () {
            ...
            return _this.hideSearch();
        });
        this.searchService.onSearchActivate().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        ...
        this.searchService.onSearchDeactivate().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        }), (0, _operators.filter)(function (data) {
            return !_this.tag || data.tag === _this.tag;
        })).subscribe(function () {
    ...
    NbSearchComponent.prototype.openSearch = function () {
        ...
        (0, _rxjs.of)(null).pipe((0, _operators.delay)(0)).subscribe(function () {
    ...
    NbSearchComponent.prototype.removeLayoutClasses = function () {
        ...
        (0, _rxjs.of)(null).pipe((0, _operators.delay)(500)).subscribe(function () {
            _this.themeService.removeLayoutClass(_this.type);
        });
    };
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbSearchComponent.prototype, "tag", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbSearchComponent.prototype, "placeholder", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbSearchComponent.prototype, "hint", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbSearchComponent.prototype, "type", void 0);
    __decorate([(0, _core.ViewChild)(_cdk.NbPortalDirective), __metadata("design:type", _cdk.NbPortalDirective)], NbSearchComponent.prototype, "searchFieldPortal", void 0);
    __decorate([(0, _core.ViewChild)('searchButton', { read: _core.ElementRef }), __metadata("design:type", _core.ElementRef)], NbSearchComponent.prototype, "searchButton", void 0);
    NbSearchComponent = __decorate([(0, _core.Component)({
        selector: 'nb-search',
        changeDetection: _core.ChangeDetectionStrategy.OnPush,
    ...
    }), __metadata("design:paramtypes", [_search.NbSearchService, _theme.NbThemeService, _router.Router, _cdk.NbOverlayService, _core.ChangeDetectorRef])], NbSearchComponent);
