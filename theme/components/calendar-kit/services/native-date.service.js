...
exports.NbNativeDateService = undefined;
...
var NbNativeDateService = /** @class */function (_super) {
    ...
    NbNativeDateService.prototype.setLocale = function (locale) {
        ...
        this.datePipe = new _common.DatePipe(locale);
    };
    ...
    NbNativeDateService.prototype.getFirstDayOfWeek = function () {
        return (0, _common.getLocaleFirstDayOfWeek)(this.locale);
    };
    NbNativeDateService.prototype.getMonthName = function (date, style) {
        if (style === void 0) {
            style = _common.TranslationWidth.Abbreviated;
        }
    ...
    NbNativeDateService.prototype.getMonthNameByIndex = function (index, style) {
        ...
        return (0, _common.getLocaleMonthNames)(this.locale, _common.FormStyle.Format, style)[index];
    };
    NbNativeDateService.prototype.getDayOfWeekNames = function () {
        return (0, _common.getLocaleDayNames)(this.locale, _common.FormStyle.Format, _common.TranslationWidth.Short);
    };
    ...
    NbNativeDateService = __decorate([(0, _core.Injectable)(), __param(0, (0, _core.Inject)(_core.LOCALE_ID)), __metadata("design:paramtypes", [String])], NbNativeDateService);
