...
exports.NbContextMenuDirective = undefined;
...
var _contextMenu = require("./context-menu.component");

var _menu = require("../menu/menu.service");
...
var NbContextMenuDirective = /** @class */function () {
    function NbContextMenuDirective(hostRef, menuService, dynamicOverlayHandler) {
         ...
         * */
        this.position = _cdk.NbPosition.BOTTOM;
        /**
         ...
         * */
        this.trigger = _cdk.NbTrigger.CLICK;
        this.alive = true;
        this._items = [];
    }
    ...
    NbContextMenuDirective.prototype.ngOnInit = function () {
        this.dynamicOverlayHandler.host(this.hostRef).componentType(_contextMenu.NbContextMenuComponent);
    };
    ...
    NbContextMenuDirective.prototype.configureDynamicOverlay = function () {
        return this.dynamicOverlayHandler.position(this.position).trigger(this.trigger).adjustment(this.adjustment).context({
    ...
    NbContextMenuDirective.prototype.subscribeOnItemClick = function () {
        var _this = this;
        this.menuService.onItemClick().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
    ...
    __decorate([(0, _core.Input)('nbContextMenuPlacement'), __metadata("design:type", String)], NbContextMenuDirective.prototype, "position", void 0);
    __decorate([(0, _core.Input)('nbContextMenuAdjustment'), __metadata("design:type", String)], NbContextMenuDirective.prototype, "adjustment", void 0);
    __decorate([(0, _core.Input)('nbContextMenuTag'), __metadata("design:type", String)], NbContextMenuDirective.prototype, "tag", void 0);
    __decorate([(0, _core.Input)('nbContextMenu'), __metadata("design:type", Array), __metadata("design:paramtypes", [Array])], NbContextMenuDirective.prototype, "items", null);
    __decorate([(0, _core.Input)('nbContextMenuTrigger'), __metadata("design:type", String)], NbContextMenuDirective.prototype, "trigger", void 0);
    NbContextMenuDirective = __decorate([(0, _core.Directive)({
        selector: '[nbContextMenu]',
        providers: [_cdk.NbDynamicOverlayHandler, _cdk.NbDynamicOverlay]
    }), __metadata("design:paramtypes", [_core.ElementRef, _menu.NbMenuService, _cdk.NbDynamicOverlayHandler])], NbContextMenuDirective);
