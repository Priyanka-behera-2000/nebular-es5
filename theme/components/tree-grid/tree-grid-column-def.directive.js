...
exports.NbTreeGridColumnDefDirective = undefined;
...
var NbTreeGridColumnDefDirective = /** @class */function (_super) {
    ...
    __decorate([(0, _core.Input)('nbTreeGridColumnDef'), __metadata("design:type", String)], NbTreeGridColumnDefDirective.prototype, "name", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Number), __metadata("design:paramtypes", [Number])], NbTreeGridColumnDefDirective.prototype, "hideOn", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Number), __metadata("design:paramtypes", [Number])], NbTreeGridColumnDefDirective.prototype, "showOn", null);
    NbTreeGridColumnDefDirective = NbTreeGridColumnDefDirective_1 = __decorate([(0, _core.Directive)({
        selector: '[nbTreeGridColumnDef]',
        providers: [{ provide: _table.NbCdkColumnDef, useExisting: NbTreeGridColumnDefDirective_1 }, { provide: _table.NB_SORT_HEADER_COLUMN_DEF, useExisting: NbTreeGridColumnDefDirective_1 }]
    })], NbTreeGridColumnDefDirective);
    return NbTreeGridColumnDefDirective;
}(_table.NbColumnDefDirective);
