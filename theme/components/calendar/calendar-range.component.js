...
exports.NbCalendarRangeComponent = undefined;
...
var NbCalendarRangeComponent = /** @class */function () {
    function NbCalendarRangeComponent(dateService) {
         ...
         * */
        this.startView = _calendarKit.NbCalendarViewMode.DATE;
        this.dayCellComponent = _calendarRangeCells.NbCalendarRangeDayCellComponent;
        this.yearCellComponent = _calendarRangeCells.NbCalendarRangeYearCellComponent;
        /**
         ...
         * */
        this.rangeChange = new _core.EventEmitter();
    }
    ...
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean)], NbCalendarRangeComponent.prototype, "boundingMonth", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbCalendarRangeComponent.prototype, "startView", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NbCalendarRangeComponent.prototype, "min", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NbCalendarRangeComponent.prototype, "max", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Function)], NbCalendarRangeComponent.prototype, "filter", void 0);
    __decorate([(0, _core.Input)('dayCellComponent'), __metadata("design:type", _core.Type), __metadata("design:paramtypes", [_core.Type])], NbCalendarRangeComponent.prototype, "_cellComponent", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", _core.Type)], NbCalendarRangeComponent.prototype, "monthCellComponent", void 0);
    __decorate([(0, _core.Input)('yearCellComponent'), __metadata("design:type", _core.Type), __metadata("design:paramtypes", [_core.Type])], NbCalendarRangeComponent.prototype, "_yearCellComponent", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbCalendarRangeComponent.prototype, "size", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NbCalendarRangeComponent.prototype, "visibleDate", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean)], NbCalendarRangeComponent.prototype, "showHeader", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NbCalendarRangeComponent.prototype, "range", void 0);
    __decorate([(0, _core.Output)(), __metadata("design:type", _core.EventEmitter)], NbCalendarRangeComponent.prototype, "rangeChange", void 0);
    NbCalendarRangeComponent = __decorate([(0, _core.Component)({
        selector: 'nb-calendar-range',
        template: "\n    <nb-base-calendar\n      [date]=\"range\"\n      (dateChange)=\"onChange($event)\"\n      [min]=\"min\"\n      [max]=\"max\"\n      [filter]=\"filter\"\n      [startView]=\"startView\"\n      [boundingMonth]=\"boundingMonth\"\n      [dayCellComponent]=\"dayCellComponent\"\n      [monthCellComponent]=\"monthCellComponent\"\n      [yearCellComponent]=\"yearCellComponent\"\n      [visibleDate]=\"visibleDate\"\n      [showHeader]=\"showHeader\"\n      [size]=\"size\"\n    ></nb-base-calendar>\n  "
    }), __metadata("design:paramtypes", [_calendarKit.NbDateService])], NbCalendarRangeComponent);
