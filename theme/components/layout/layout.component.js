...
exports.NbLayoutComponent = exports.NbLayoutFooterComponent = exports.NbLayoutHeaderComponent = exports.NbLayoutColumnComponent = undefined;
...
var _theme = require("../../services/theme.service");
...
var _theme2 = require("../../theme.options");

var _overlayContainerAdapter = require("../cdk/adapter/overlay-container-adapter");
...
var NbLayoutColumnComponent = /** @class */function () {
    ...
    Object.defineProperty(NbLayoutColumnComponent.prototype, "left", {
        ...
        set: function set(val) {
            this.leftValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    Object.defineProperty(NbLayoutColumnComponent.prototype, "start", {
         ...
         */
        set: function set(val) {
            this.startValue = (0, _helpers.convertToBoolProperty)(val);
            this.leftValue = false;
        },
        enumerable: true,
        configurable: true
    });
    __decorate([(0, _core.HostBinding)('class.left'), __metadata("design:type", Boolean)], NbLayoutColumnComponent.prototype, "leftValue", void 0);
    __decorate([(0, _core.HostBinding)('class.start'), __metadata("design:type", Boolean)], NbLayoutColumnComponent.prototype, "startValue", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutColumnComponent.prototype, "left", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutColumnComponent.prototype, "start", null);
    NbLayoutColumnComponent = __decorate([(0, _core.Component)({
...
var NbLayoutHeaderComponent = /** @class */function () {
    ...
    Object.defineProperty(NbLayoutHeaderComponent.prototype, "fixed", {
         ...
         */
        set: function set(val) {
            this.fixedValue = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NbLayoutHeaderComponent.prototype, "subheader", {
         ...
         */
        set: function set(val) {
            this.subheaderValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    __decorate([(0, _core.HostBinding)('class.fixed'), __metadata("design:type", Boolean)], NbLayoutHeaderComponent.prototype, "fixedValue", void 0);
    __decorate([(0, _core.HostBinding)('class.subheader'), __metadata("design:type", Boolean)], NbLayoutHeaderComponent.prototype, "subheaderValue", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutHeaderComponent.prototype, "fixed", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutHeaderComponent.prototype, "subheader", null);
    NbLayoutHeaderComponent = __decorate([(0, _core.Component)({
        selector: 'nb-layout-header',
        template: "\n    <nav [class.fixed]=\"fixedValue\">\n      <ng-content></ng-content>\n    </nav>\n  "
    }), __param(0, (0, _core.Inject)((0, _core.forwardRef)(function () {
        return NbLayoutComponent;
    }))), __metadata("design:paramtypes", [NbLayoutComponent])], NbLayoutHeaderComponent);
...
var NbLayoutFooterComponent = /** @class */function () {
    ...
    __decorate([(0, _core.HostBinding)('class.fixed'), __metadata("design:type", Boolean)], NbLayoutFooterComponent.prototype, "fixedValue", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutFooterComponent.prototype, "fixed", null);
    NbLayoutFooterComponent = __decorate([(0, _core.Component)({
...
var NbLayoutComponent = /** @class */function () {
    function NbLayoutComponent(themeService, spinnerService, elementRef, renderer, window, document, platformId, layoutDirectionService, scrollService, rulerService, scrollTop, overlayContainer) {
        ...
        this.afterViewInit$ = new _rxjs.BehaviorSubject(null);
        this.alive = true;
        this.registerAsOverlayContainer();
        this.themeService.onThemeChange().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        ...
        this.themeService.onAppendLayoutClass().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (className) {
            _this.renderer.addClass(_this.elementRef.nativeElement, className);
        });
        this.themeService.onRemoveLayoutClass().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (className) {
        ...
        this.spinnerService.registerLoader(new Promise(function (resolve, reject) {
            _this.afterViewInit$.pipe((0, _operators.takeWhile)(function () {
                return _this.alive;
        ...
        this.rulerService.onGetDimensions().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        ...
        this.scrollService.onGetPosition().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (_a) {
            var listener = _a.listener;
        ...
        this.scrollTop.shouldRestore().pipe((0, _operators.filter)(function () {
            return _this.restoreScrollTopValue;
        }), (0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function () {
            _this.scroll(0, 0);
        });
        this.scrollService.onScrollableChange().pipe((0, _operators.filter)(function () {
            return _this.withScrollValue;
    ...
    Object.defineProperty(NbLayoutComponent.prototype, "center", {
         ...
         */
        set: function set(val) {
            this.centerValue = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NbLayoutComponent.prototype, "windowMode", {
         ...
         */
        set: function set(val) {
            this.windowModeValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    Object.defineProperty(NbLayoutComponent.prototype, "withScroll", {
         ...
         */
        set: function set(val) {
            this.withScrollValue = (0, _helpers.convertToBoolProperty)(val);
    ...
    Object.defineProperty(NbLayoutComponent.prototype, "restoreScrollTop", {
         ...
         */
        set: function set(val) {
            this.restoreScrollTopValue = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    NbLayoutComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.layoutDirectionService.onDirectionChange().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (direction) {
            return _this.document.dir = direction;
        });
        this.scrollService.onManualScroll().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
        })).subscribe(function (_a) {
            var x = _a.x,
                y = _a.y;
    ...
    NbLayoutComponent.prototype.getScrollPosition = function () {
        ...
        var x = -documentRect.left || this.document.body.scrollLeft || this.window.scrollX || this.document.documentElement.scrollLeft || 0;
        var y = -documentRect.top || this.document.body.scrollTop || this.window.scrollY || this.document.documentElement.scrollTop || 0;
        return { x: x, y: y };
    };
    ...
    __decorate([(0, _core.HostBinding)('class.window-mode'), __metadata("design:type", Boolean)], NbLayoutComponent.prototype, "windowModeValue", void 0);
    __decorate([(0, _core.HostBinding)('class.with-scroll'), __metadata("design:type", Boolean)], NbLayoutComponent.prototype, "withScrollValue", void 0);
    __decorate([(0, _core.HostBinding)('class.with-subheader'), __metadata("design:type", Boolean)], NbLayoutComponent.prototype, "withSubheader", void 0);
    __decorate([(0, _core.HostBinding)('class.overlay-scroll-block'), __metadata("design:type", Boolean)], NbLayoutComponent.prototype, "overlayScrollBlock", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutComponent.prototype, "center", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutComponent.prototype, "windowMode", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutComponent.prototype, "withScroll", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbLayoutComponent.prototype, "restoreScrollTop", null);
    __decorate([(0, _core.ViewChild)('layoutTopDynamicArea', { read: _core.ViewContainerRef }), __metadata("design:type", _core.ViewContainerRef)], NbLayoutComponent.prototype, "veryTopRef", void 0);
    __decorate([(0, _core.ViewChild)('scrollableContainer', { read: _core.ElementRef }), __metadata("design:type", _core.ElementRef)], NbLayoutComponent.prototype, "scrollableContainerRef", void 0);
    __decorate([(0, _core.HostListener)('window:scroll', ['$event']), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NbLayoutComponent.prototype, "onScroll", null);
    __decorate([(0, _core.HostListener)('window:resize', ['$event']), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], NbLayoutComponent.prototype, "onResize", null);
    NbLayoutComponent = __decorate([(0, _core.Component)({
        selector: 'nb-layout',
    ...
    }), __param(4, (0, _core.Inject)(_theme2.NB_WINDOW)), __param(5, (0, _core.Inject)(_theme2.NB_DOCUMENT)), __param(6, (0, _core.Inject)(_core.PLATFORM_ID)), __metadata("design:paramtypes", [_theme.NbThemeService, _spinner.NbSpinnerService, _core.ElementRef, _core.Renderer2, Object, Object, Object, _direction.NbLayoutDirectionService, _scroll.NbLayoutScrollService, _ruler.NbLayoutRulerService, _restoreScrollTop.NbRestoreScrollTopHelper, _overlayContainerAdapter.NbOverlayContainerAdapter])], NbLayoutComponent);
    return NbLayoutComponent;
}();
