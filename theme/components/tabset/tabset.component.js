...
exports.NbTabsetComponent = exports.NbTabComponent = undefined;
...
var NbTabComponent = /** @class */function () {
    ...
    Object.defineProperty(NbTabComponent.prototype, "active", {
        ...
        set: function set(val) {
            this.activeValue = (0, _helpers.convertToBoolProperty)(val);
            if (this.activeValue) {
                this.init = true;
            }
        },
    ...
    Object.defineProperty(NbTabComponent.prototype, "lazyLoad", {
         ...
         */
        set: function set(val) {
            this.init = (0, _helpers.convertToBoolProperty)(val);
        },
        enumerable: true,
        configurable: true
    });
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "tabTitle", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "tabIcon", void 0);
    __decorate([(0, _core.Input)('disabled'), (0, _core.HostBinding)('class.disabled'), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbTabComponent.prototype, "disabled", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbTabComponent.prototype, "responsive", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "route", void 0);
    __decorate([(0, _core.HostBinding)('class.content-active'), __metadata("design:type", Boolean)], NbTabComponent.prototype, "activeValue", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbTabComponent.prototype, "active", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbTabComponent.prototype, "lazyLoad", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "badgeText", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "badgeStatus", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabComponent.prototype, "badgePosition", void 0);
    NbTabComponent = __decorate([(0, _core.Component)({
        selector: 'nb-tab',
...
var NbTabsetComponent = /** @class */function () {
    ...
    NbTabsetComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        this.route.params.pipe((0, _operators.map)(function (params) {
            return _this.tabs.find(function (tab) {
                return _this.routeParam ? tab.route === params[_this.routeParam] : tab.active;
            });
        }), (0, _operators.delay)(0), (0, _operators.map)(function (tab) {
            return tab || _this.tabs.first;
        }), (0, _operators.filter)(function (tab) {
            return !!tab;
    ...
    NbTabsetComponent.prototype.selectTab = function (selectedTab) {
        if (!selectedTab.disabled) {
            this.tabs.forEach(function (tab) {
                return tab.active = tab === selectedTab;
            });
            this.changeTab.emit(selectedTab);
        }
    };
    __decorate([(0, _core.ContentChildren)(NbTabComponent), __metadata("design:type", _core.QueryList)], NbTabsetComponent.prototype, "tabs", void 0);
    __decorate([(0, _core.HostBinding)('class.full-width'), __metadata("design:type", Boolean)], NbTabsetComponent.prototype, "fullWidthValue", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Boolean), __metadata("design:paramtypes", [Boolean])], NbTabsetComponent.prototype, "fullWidth", null);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NbTabsetComponent.prototype, "routeParam", void 0);
    __decorate([(0, _core.Output)(), __metadata("design:type", Object)], NbTabsetComponent.prototype, "changeTab", void 0);
    NbTabsetComponent = __decorate([(0, _core.Component)({
        selector: 'nb-tabset',
    ...
    }), __metadata("design:paramtypes", [_router.ActivatedRoute, _core.ChangeDetectorRef])], NbTabsetComponent);
