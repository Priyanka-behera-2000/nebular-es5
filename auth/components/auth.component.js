...
exports.NbAuthComponent = undefined;
...
var NbAuthComponent = /** @class */function () {
    ...
    function NbAuthComponent(auth, location) {
        ...
        this.token = '';
        this.subscription = auth.onAuthenticationChange().pipe((0, _operators.takeWhile)(function () {
            return _this.alive;
