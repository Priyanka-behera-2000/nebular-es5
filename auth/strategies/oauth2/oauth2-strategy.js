...
exports.NbOAuth2AuthStrategy = undefined;
...
var _oauth2Strategy = require("./oauth2-strategy.options");
...
var NbOAuth2AuthStrategy = /** @class */function (_super) {
    ...
    function NbOAuth2AuthStrategy(http, route, window) {
        ...
        _this.route = route;
        _this.window = window;
        _this.redirectResultHandlers = (_a = {}, _a[_oauth2Strategy.NbOAuth2ResponseType.CODE] = function () {
            return (0, _rxjs.of)(_this.route.snapshot.queryParams).pipe((0, _operators.switchMap)(function (params) {
                if (params.code) {
                    return _this.requestToken(params.code);
                }
                return (0, _rxjs.of)(new _services.NbAuthResult(false, params, _this.getOption('redirect.failure'), _this.getOption('defaultErrors'), []));
            }));
        }, _a[_oauth2Strategy.NbOAuth2ResponseType.TOKEN] = function () {
            var module = 'authorize';
            var requireValidToken = _this.getOption(module + ".requireValidToken");
            return (0, _rxjs.of)(_this.route.snapshot.fragment).pipe((0, _operators.map)(function (fragment) {
                return _this.parseHashAsQueryParams(fragment);
            }), (0, _operators.map)(function (params) {
                if (!params.error) {
                    return new _services.NbAuthResult(true, params, _this.getOption('redirect.success'), [], _this.getOption('defaultMessages'), _this.createToken(params, requireValidToken));
                }
                return new _services.NbAuthResult(false, params, _this.getOption('redirect.failure'), _this.getOption('defaultErrors'), []);
            }), (0, _operators.catchError)(function (err) {
                var errors = [];
                if (err instanceof _services.NbAuthIllegalTokenError) {
                    errors.push(err.message);
                } else {
                    errors.push('Something went wrong.');
                }
                return (0, _rxjs.of)(new _services.NbAuthResult(false, err, _this.getOption('redirect.failure'), errors));
            }));
        }, _a);
        _this.redirectResults = (_b = {}, _b[_oauth2Strategy.NbOAuth2ResponseType.CODE] = function () {
            return (0, _rxjs.of)(_this.route.snapshot.queryParams).pipe((0, _operators.map)(function (params) {
                return !!(params && (params.code || params.error));
            }));
        }, _b[_oauth2Strategy.NbOAuth2ResponseType.TOKEN] = function () {
            return (0, _rxjs.of)(_this.route.snapshot.fragment).pipe((0, _operators.map)(function (fragment) {
                return _this.parseHashAsQueryParams(fragment);
            }), (0, _operators.map)(function (params) {
        ...
        _this.defaultOptions = _oauth2Strategy.auth2StrategyOptions;
        return _this;
    }
    ...
    NbOAuth2AuthStrategy.prototype.authenticate = function (data) {
        var _this = this;
        if (this.getOption('token.grantType') === _oauth2Strategy.NbOAuth2GrantType.PASSWORD) {
            return this.passwordToken(data.email, data.password);
        } else {
            return this.isRedirectResult().pipe((0, _operators.switchMap)(function (result) {
                if (!result) {
                    _this.authorizeRedirect();
                    return (0, _rxjs.of)(new _services.NbAuthResult(true));
                }
    ...
    NbOAuth2AuthStrategy.prototype.refreshToken = function (token) {
        ...
        var headers = this.buildAuthHeader() || new _http.HttpHeaders();
        headers = headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return this.http.post(url, this.buildRefreshRequestData(token), { headers: headers }).pipe((0, _operators.map)(function (res) {
            return new _services.NbAuthResult(true, res, _this.getOption('redirect.success'), [], _this.getOption('defaultMessages'), _this.createRefreshedToken(res, token, requireValidToken));
    ...
    NbOAuth2AuthStrategy.prototype.passwordToken = function (username, password) {
        ...
        var headers = this.buildAuthHeader() || new _http.HttpHeaders();
        headers = headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return this.http.post(url, this.buildPasswordRequestData(username, password), { headers: headers }).pipe((0, _operators.map)(function (res) {
            return new _services.NbAuthResult(true, res, _this.getOption('redirect.success'), [], _this.getOption('defaultMessages'), _this.createToken(res, requireValidToken));
        }), (0, _operators.catchError)(function (res) {
            return _this.handleResponseError(res);
        }));
    };
    ...
    NbOAuth2AuthStrategy.prototype.requestToken = function (code) {
        ...
        var headers = this.buildAuthHeader() || new _http.HttpHeaders();
        headers = headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return this.http.post(url, this.buildCodeRequestData(code), { headers: headers }).pipe((0, _operators.map)(function (res) {
            return new _services.NbAuthResult(true, res, _this.getOption('redirect.success'), [], _this.getOption('defaultMessages'), _this.createToken(res, requireValidToken));
        }), (0, _operators.catchError)(function (res) {
            return _this.handleResponseError(res);
        }));
    ...
    NbOAuth2AuthStrategy.prototype.buildAuthHeader = function () {
        if (this.clientAuthMethod === _oauth2Strategy.NbOAuth2ClientAuthMethod.BASIC) {
            if (this.getOption('clientId') && this.getOption('clientSecret')) {
                return new _http.HttpHeaders({
    ...
    NbOAuth2AuthStrategy.prototype.addCredentialsToParams = function (params) {
        if (this.clientAuthMethod === _oauth2Strategy.NbOAuth2ClientAuthMethod.REQUEST_BODY) {
            if (this.getOption('clientId') && this.getOption('clientSecret')) {
    ...
    NbOAuth2AuthStrategy.prototype.handleResponseError = function (res) {
        ...
        } else if (res instanceof _services.NbAuthIllegalTokenError) {
            errors.push(res.message);
        } else {
            errors.push('Something went wrong.');
        }
        ;
        return (0, _rxjs.of)(new _services.NbAuthResult(false, res, this.getOption('redirect.failure'), errors, []));
    };
    ...
    NbOAuth2AuthStrategy = NbOAuth2AuthStrategy_1 = __decorate([(0, _core.Injectable)(), __param(2, (0, _core.Inject)(_theme.NB_WINDOW)), __metadata("design:paramtypes", [_http.HttpClient, _router.ActivatedRoute, Object])], NbOAuth2AuthStrategy);
